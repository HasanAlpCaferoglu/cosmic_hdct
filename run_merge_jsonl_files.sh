...
# ========================================
#
#SBATCH --job-name=merge_jsonl_files         #Setting a job name
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=outputs/merge_jsonl_files_%j.out    # Standard output log file
...
python3 -u merge_jsonl_files.py