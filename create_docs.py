...
if __name__ == "__main__":
    ...
    # parser.add_argument("--line_end_row_index", default='2000000', type=str, help='Enter msmarco dataset start row for creating documents (exclusive)' )
    parser.add_argument("--line_start_row_index", default='2000000', type=str, help='Enter msmarco dataset start row for creating documents (inclusive)' )
